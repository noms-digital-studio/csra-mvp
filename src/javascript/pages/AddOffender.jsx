                    ...
                    <fieldset>
                        ...
                        <div className="form-date">
                            <div className="form-group form-group-day">
                                ...
                                <input className="form-control" id="dob-day" name="dob-day" type="number" pattern="[0-9]*" min="0" max="31" aria-describedby="dob-hint" />
                            </div>
                            <div className="form-group form-group-month">
                                <label className="form-label" htmlFor="dob-month">Month</label>
                                <input className="form-control" id="dob-month" name="dob-month" type="number" pattern="[0-9]*" min="0" max="12" />
                            </div>
                            <div className="form-group form-group-year">
                                <label className="form-label" htmlFor="dob-year">Year</label>
                                <input className="form-control" id="dob-year" name="dob-year" type="number" pattern="[0-9]*" min="0" max="2016" />
                            </div>
                        </div>
                    </fieldset>
                </div>
